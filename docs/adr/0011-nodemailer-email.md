...
- MailHog must be running locally for email to work. `pnpm db` starts it alongside Postgres — this is documented in the README and is the intended dev workflow.
